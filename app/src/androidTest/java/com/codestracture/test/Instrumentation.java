package com.codestracture.test;
...
import com.codestracture.app.TestApp_Application;
...
@CucumberOptions(features = "features", glue = "com.codestracture.test.steps", strict = true)
public class Instrumentation extends CucumberAndroidJUnitRunner {
    ...
    public void onCreate(final Bundle bundle) {
        ...
        boolean isFolderCreated = new File(getAbsoluteFilesPath()).mkdirs();
        Log.d("MyTag","isFolderCreated::"+isFolderCreated);

        String tags = "@login-feature"; //"@login-feature";
        bundle.putString("tags", tags.replaceAll(",", "--").replaceAll("\\s", ""));
    ...
    public Application newApplication(ClassLoader cl, String className, Context context) throws ClassNotFoundException, IllegalAccessException, InstantiationException {
        return super.newApplication(cl, TestApp_Application.class.getName(), context);
    }
}
